...
public class PlayerInstance {
    ...
    public PlayerInstance() {
        ...
        playerManager.registerSourceManager(new dev.lavalink.youtube.YoutubeAudioSourceManager(true, new MusicWithThumbnail(), new WebWithThumbnail(), new AndroidTestsuiteWithThumbnail()));
    ...
    public void PlayTrackTo(GenericEvent event, final TextChannel textChannel, final VoiceChannel voiceChannel, String video, @Nullable Consumer<AudioTrack> callback) throws IOException, ParseException, SpotifyWebApiException {
        ...
        if (video.contains("spotify")) {
            ...
            System.out.printf("[PlayInstance#%s] Spotify Track convert to Youtube Track : %s%n", textChannel.getGuild().getId(), tracks.get(0).uri);
        }
